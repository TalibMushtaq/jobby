...
-- CreateEnum
CREATE TYPE "InterviewProbability" AS ENUM ('LOW', 'MEDIUM', 'HIGH');
...
CREATE TABLE "Analysis" (
    ...
    "interviewProbability" "InterviewProbability" NOT NULL,
    "scamRisk" "RiskLevel" NOT NULL,
    "scamRiskScore" INTEGER NOT NULL,
    "ghostJobRisk" "RiskLevel" NOT NULL,
...
-- CreateIndex
CREATE INDEX "Analysis_resumeId_createdAt_idx" ON "Analysis"("resumeId", "createdAt");

-- CreateIndex
CREATE INDEX "OptimizedResume_userId_createdAt_idx" ON "OptimizedResume"("userId", "createdAt");

-- CreateIndex
CREATE INDEX "OptimizedResume_analysisId_createdAt_idx" ON "OptimizedResume"("analysisId", "createdAt");
